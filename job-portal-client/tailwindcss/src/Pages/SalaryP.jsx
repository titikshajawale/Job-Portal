...
const SalaryP = () => {
  ...
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4">
      ...
      <div className="mt-5">
        <div div className="search-box p-2 text-center mb-2">
          <input
            type="text"
            name="search"
            id="search"
          ...
          <button onClick={handleSearch} className="bg-blue text-white font-semibold px-8 py-2 rounded-sm mb-4 w">
            Search
          </button>
        </div>
      </div>
