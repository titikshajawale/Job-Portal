...
const Banner = ({query,handleInputChange}) => {
  ...
  return (
    ...
    <p className='text-lg text-black/70 mb-8'>Thousands of job in the computer , engineering and the technology sectors are waiting for you.</p>
    <form>
      <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
        <div className='flex md:rounded-s-md rounded  shadow-sm ring-1  focus-within:ring-2 focus-within: ring-inset focus-within: ring-indigo-600 md:w-1/2 w-full'>
        ...
        <div className='flex md:rounded-s-none rounded  shadow-sm ring-1  focus-within:ring-2 focus-within: ring-inset focus-within: ring-indigo-600 md:w-1/3 w-full'>
